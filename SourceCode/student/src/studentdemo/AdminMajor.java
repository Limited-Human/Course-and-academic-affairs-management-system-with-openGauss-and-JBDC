...
public class AdminMajor {
    ...
    JLabel laCno,laName,laWay,laCollege;
    JTextField txtCno,txtName,txtRenshu;
    ...
    public AdminMajor(){
        ...
        laCno = new JLabel("专业编号:");

        laCno.setPreferredSize(new Dimension(0,50));
        laName = new JLabel("专业名称:");



        laWay = new JLabel("开设学院:");
        ...
        ResultSet dp;
        try {
            String sql="SELECT * FROM liuz_college01;";
        ...
        //设置列名
        columnNames.add("专业编号");
        columnNames.add("专业名称");
        columnNames.add("专业人数");
        columnNames.add("所属学院");
        Vector rowData = new Vector();
        //rowData可以存放多行,开始从数据库里取
        try {
            rs= con.gsqlquery(con.GetCon(), "select * from liuz_major01;");
    ...
    public void MyEvent(){
        ...
        btnAdd.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent arg0) {
                ...
                sql = "insert into liuz_major01 values( '" + txtCno.getText() + "','" + txtName.getText()  +"','" + txtRenshu.getText()  +"','"
                        + de.toNber()+ "');";
                a= con.gsqlexc(con.GetCon(), sql);
                if(a>0) {
                    tableModel.addRow(new Object[] {txtCno.getText(), txtName.getText(),txtRenshu.getText(),de.toNber()
                            });
                    txtCno.setText("");;
                    txtName.setText("");
                    txtRenshu.setText("");
        ...
        btnDelete.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent arg0) {
                ...
                String sql="delete from liuz_major01 where lz_mno01='" + table.getValueAt(rowcount, 0)+"';";
        ...
        btnChange.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                String sql="update liuz_major01 set lz_mname01 ='" + table.getValueAt(rowcount, 1)+
                        "',lz_maj_count01='"+table.getValueAt(rowcount, 2)+
                        "',lz_cno01='"+table.getValueAt(rowcount, 3)+
                        "'where lz_mno01 ='"+table.getValueAt(rowcount, 0) +"';";
